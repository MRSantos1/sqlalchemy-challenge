...
def home():
    return (f"Welcome to the Hawaii Climate API<br/>"
            ...
            f"/api/v1.0/datesearch/low, high, and average temp for date given and each date after<br/>"
            f"/api/v1.0/datesearch/ low, high, and average temp for date given and each date up to and including end date<br/>"
            f"-------------------------------------<br/>"
            f"data available from 2016-08-23 to 2017-08-23<br/>"
            f"-------------------------------------")
